...
tf.app.flags.DEFINE_integer("until", 4000, "Number of training examples (for learning curve)")
...
def main(_):
    ...
    idraggn = IDRAGGN(FLAGS.means_train_path, FLAGS.ends_train_path, FLAGS.means_test_path, FLAGS.ends_test_path, is_pik=FLAGS.is_pik,
                      pik_train_path=FLAGS.pik_train, pik_test_path=FLAGS.pik_test, until=FLAGS.until,
                      restore="checkpoints/idraggn.ckpt")
